...
public class Vertices {
	...
	private static final int MVP_MATRIX_INDEX_CNT = 1; // Number of Components
														// in MVP matrix index
	...
	public Vertices(int maxVertices, int maxIndices) {
		...
		this.vertexStride = this.positionCnt + TEXCOORD_CNT
				+ MVP_MATRIX_INDEX_CNT; // Calculate Vertex Stride
	...
	public void bind() {
		...
		vertices.position(positionCnt); // Set Vertex Buffer to Texture Coords
										// (NOTE: position based on whether
